...
constexpr std::string_view PHONG_LIGTHMAP_VERTEX {
		"src/Engine/util/shaders/Phong_Lightmaps/vertex.glsl"
};

constexpr std::string_view PHONG_LIGTHMAP_FRAGMENT {
		"src/Engine/util/shaders/Phong_Lightmaps/fragment.glsl"
};

constexpr std::string_view PHONG_LIGTHMAP_SHADER [SHADER_TYPES] {
		PHONG_LIGTHMAP_VERTEX,
		PHONG_LIGTHMAP_FRAGMENT
