...
constexpr char const * DOOR_TEXTURE				= "./img/textures/testing/testing_door.png";
constexpr char const * KEY_TEXTURE				= "./img/textures/testing/testing_key.png";
constexpr char const * DEMON_TEXTURE 			= "./img/textures/testing/testing_demon.jpg";
constexpr char const * ANGEL_TEXTURE			= "./img/textures/testing/testing_angel.jpg";
constexpr char const * ENEMY_TEXTURE 			= "./img/textures/testing/testing_enemy.png";
