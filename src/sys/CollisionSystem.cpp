...
void CollisionSystem::update(EntityPlayer& player, const std::vector<std::unique_ptr<EntityDoor>>& doors, const std::vector<std::unique_ptr<EntityKey>>& keys)
{
...
void CollisionSystem::update(EntityPlayer& player, const std::vector<std::unique_ptr<EntityDoor>>& doors) const {
	for(auto & door : doors) {
...
void CollisionSystem::update(EntityPlayer& player, const std::vector<std::unique_ptr<EntityKey>>& keys) const {
	for(auto & key : keys) {
